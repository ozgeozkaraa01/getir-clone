  ...
  return (
    <div className="p-3 bg-white">
      <picture className="relative block">
        <button className="w-8 h-8 flex absolute top-0 right-2 border shadow-md rounded-lg border-gray-200 text-brand-color transition-colors bg-white hover:bg-brand-color hover:text-brand-yellow items-center justify-center">
          <AiOutlinePlus />
        </button>
